    ...
    importsObject.hooks = {
        ...
        br_table: function (func, instr, br_table_info_idx, table_idx) {
            br_table({
                func,
                instr
            }, staticInfo.br_tables[br_table_info_idx].table, staticInfo.br_tables[br_table_info_idx].default, table_idx);
        },
...
// define analysis callbacks that were not defined by the user
