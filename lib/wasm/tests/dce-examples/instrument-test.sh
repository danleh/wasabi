...
# NOTE: do not pass in the .wasm file path, just the path of the directory containing it 

# NOTE: Check the instrumented-index.js file to make sure the require of collect.js is in the right place
