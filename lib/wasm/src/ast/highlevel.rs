...
impl Instr {
    ...
    pub fn parse_text(str: &str) -> Result<Self, ()> {
        ...
        fn parse_load_memarg(str: &str, load_op: LoadOp) -> Result<Memarg, ()> {
            parse_memarg(str, load_op.natural_alignment_exp())
        }
        fn parse_store_memarg(str: &str, store_op: StoreOp) -> Result<Memarg, ()> {
        ...
        Ok(match operator {
            ...
            "i32.const" => Const(Val::parse_text(rest, ValType::I32)?),
            "i64.const" => Const(Val::parse_text(rest, ValType::I64)?),
            "f32.const" => Const(Val::parse_text(rest, ValType::F32)?),
            "f64.const" => Const(Val::parse_text(rest, ValType::F64)?),
            
            "i32.load" => Load(I32Load, parse_load_memarg(rest, I32Load)?),
            "i64.load" => Load(I64Load, parse_load_memarg(rest, I64Load)?),
            "f32.load" => Load(F32Load, parse_load_memarg(rest, F32Load)?),
            "f64.load" => Load(F64Load, parse_load_memarg(rest, F64Load)?),
            "i32.load8_s" => Load(I32Load8S, parse_load_memarg(rest, I32Load8S)?),
            "i32.load8_u" => Load(I32Load8U, parse_load_memarg(rest, I32Load8U)?),
            "i32.load16_s" => Load(I32Load16S, parse_load_memarg(rest, I32Load16S)?),
            "i32.load16_u" => Load(I32Load16U, parse_load_memarg(rest, I32Load16U)?),
            "i64.load8_s" => Load(I64Load8S, parse_load_memarg(rest, I64Load8S)?),
            "i64.load8_u" => Load(I64Load8U, parse_load_memarg(rest, I64Load8U)?),
            "i64.load16_s" => Load(I64Load16S, parse_load_memarg(rest, I64Load16S)?),
            "i64.load16_u" => Load(I64Load16U, parse_load_memarg(rest, I64Load16U)?),
            "i64.load32_s" => Load(I64Load32S, parse_load_memarg(rest, I64Load32S)?),
            "i64.load32_u" => Load(I64Load32U, parse_load_memarg(rest, I64Load32U)?),

            "i32.store" => Store(I32Store, parse_store_memarg(rest, I32Store)?),
            "i64.store" => Store(I64Store, parse_store_memarg(rest, I64Store)?),
            "f32.store" => Store(F32Store, parse_store_memarg(rest, F32Store)?),
            "f64.store" => Store(F64Store, parse_store_memarg(rest, F64Store)?),
            "i32.store8" => Store(I32Store8, parse_store_memarg(rest, I32Store8)?),
            "i32.store16" => Store(I32Store16, parse_store_memarg(rest, I32Store16)?),
            "i64.store8" => Store(I64Store8, parse_store_memarg(rest, I64Store8)?),
            "i64.store16" => Store(I64Store16, parse_store_memarg(rest, I64Store16)?),
            "i64.store32" => Store(I64Store32, parse_store_memarg(rest, I64Store32)?),
            
            "i32.eqz" => Numeric(I32Eqz),
            "i64.eqz" => Numeric(I64Eqz),
            "i32.clz" => Numeric(I32Clz),
            "i32.ctz" => Numeric(I32Ctz),
            "i32.popcnt" => Numeric(I32Popcnt),
            "i64.clz" => Numeric(I64Clz),
            "i64.ctz" => Numeric(I64Ctz),
            "i64.popcnt" => Numeric(I64Popcnt),
            "f32.abs" => Numeric(F32Abs),
            "f32.neg" => Numeric(F32Neg),
            "f32.ceil" => Numeric(F32Ceil),
            "f32.floor" => Numeric(F32Floor),
            "f32.trunc" => Numeric(F32Trunc),
            "f32.nearest" => Numeric(F32Nearest),
            "f32.sqrt" => Numeric(F32Sqrt),
            "f64.abs" => Numeric(F64Abs),
            "f64.neg" => Numeric(F64Neg),
            "f64.ceil" => Numeric(F64Ceil),
            "f64.floor" => Numeric(F64Floor),
            "f64.trunc" => Numeric(F64Trunc),
            "f64.nearest" => Numeric(F64Nearest),
            "f64.sqrt" => Numeric(F64Sqrt),
            "i32.wrap_i64" => Numeric(I32WrapI64),
            "i32.trunc_f32_s" => Numeric(I32TruncF32S),
            "i32.trunc_f32_u" => Numeric(I32TruncF32U),
            "i32.trunc_f64_s" => Numeric(I32TruncF64S),
            "i32.trunc_f64_u" => Numeric(I32TruncF64U),
            "i64.extend_i32_s" => Numeric(I64ExtendI32S),
            "i64.extend_i32_u" => Numeric(I64ExtendI32U),
            "i64.trunc_f32_s" => Numeric(I64TruncF32S),
            "i64.trunc_f32_u" => Numeric(I64TruncF32U),
            "i64.trunc_f64_s" => Numeric(I64TruncF64S),
            "i64.trunc_f64_u" => Numeric(I64TruncF64U),
            "f32.convert_i32_s" => Numeric(F32ConvertI32S),
            "f32.convert_i32_u" => Numeric(F32ConvertI32U),
            "f32.convert_i64_s" => Numeric(F32ConvertI64S),
            "f32.convert_i64_u" => Numeric(F32ConvertI64U),
            "f32.demote_f64" => Numeric(F32DemoteF64),
            "f64.convert_i32_s" => Numeric(F64ConvertI32S),
            "f64.convert_i32_u" => Numeric(F64ConvertI32U),
            "f64.convert_i64_s" => Numeric(F64ConvertI64S),
            "f64.convert_i64_u" => Numeric(F64ConvertI64U),
            "f64.promote_f32" => Numeric(F64PromoteF32),
            "i32.reinterpret_f32" => Numeric(I32ReinterpretF32),
            "i64.reinterpret_f64" => Numeric(I64ReinterpretF64),
            "f32.reinterpret_i32" => Numeric(F32ReinterpretI32),
            "f64.reinterpret_i64" => Numeric(F64ReinterpretI64),
            "i32.eq" => Numeric(I32Eq),
            "i32.ne" => Numeric(I32Ne),
            "i32.lt_s" => Numeric(I32LtS),
            "i32.lt_u" => Numeric(I32LtU),
            "i32.gt_s" => Numeric(I32GtS),
            "i32.gt_u" => Numeric(I32GtU),
            "i32.le_s" => Numeric(I32LeS),
            "i32.le_u" => Numeric(I32LeU),
            "i32.ge_s" => Numeric(I32GeS),
            "i32.ge_u" => Numeric(I32GeU),
            "i64.eq" => Numeric(I64Eq),
            "i64.ne" => Numeric(I64Ne),
            "i64.lt_s" => Numeric(I64LtS),
            "i64.lt_u" => Numeric(I64LtU),
            "i64.gt_s" => Numeric(I64GtS),
            "i64.gt_u" => Numeric(I64GtU),
            "i64.le_s" => Numeric(I64LeS),
            "i64.le_u" => Numeric(I64LeU),
            "i64.ge_s" => Numeric(I64GeS),
            "i64.ge_u" => Numeric(I64GeU),
            "f32.eq" => Numeric(F32Eq),
            "f32.ne" => Numeric(F32Ne),
            "f32.lt" => Numeric(F32Lt),
            "f32.gt" => Numeric(F32Gt),
            "f32.le" => Numeric(F32Le),
            "f32.ge" => Numeric(F32Ge),
            "f64.eq" => Numeric(F64Eq),
            "f64.ne" => Numeric(F64Ne),
            "f64.lt" => Numeric(F64Lt),
            "f64.gt" => Numeric(F64Gt),
            "f64.le" => Numeric(F64Le),
            "f64.ge" => Numeric(F64Ge),
            "i32.add" => Numeric(I32Add),
            "i32.sub" => Numeric(I32Sub),
            "i32.mul" => Numeric(I32Mul),
            "i32.div_s" => Numeric(I32DivS),
            "i32.div_u" => Numeric(I32DivU),
            "i32.rem_s" => Numeric(I32RemS),
            "i32.rem_u" => Numeric(I32RemU),
            "i32.and" => Numeric(I32And),
            "i32.or" => Numeric(I32Or),
            "i32.xor" => Numeric(I32Xor),
            "i32.shl" => Numeric(I32Shl),
            "i32.shr_s" => Numeric(I32ShrS),
            "i32.shr_u" => Numeric(I32ShrU),
            "i32.rotl" => Numeric(I32Rotl),
            "i32.rotr" => Numeric(I32Rotr),
            "i64.add" => Numeric(I64Add),
            "i64.sub" => Numeric(I64Sub),
            "i64.mul" => Numeric(I64Mul),
            "i64.div_s" => Numeric(I64DivS),
            "i64.div_u" => Numeric(I64DivU),
            "i64.rem_s" => Numeric(I64RemS),
            "i64.rem_u" => Numeric(I64RemU),
            "i64.and" => Numeric(I64And),
            "i64.or" => Numeric(I64Or),
            "i64.xor" => Numeric(I64Xor),
            "i64.shl" => Numeric(I64Shl),
            "i64.shr_s" => Numeric(I64ShrS),
            "i64.shr_u" => Numeric(I64ShrU),
            "i64.rotl" => Numeric(I64Rotl),
            "i64.rotr" => Numeric(I64Rotr),
            "f32.add" => Numeric(F32Add),
            "f32.sub" => Numeric(F32Sub),
            "f32.mul" => Numeric(F32Mul),
            "f32.div" => Numeric(F32Div),
            "f32.min" => Numeric(F32Min),
            "f32.max" => Numeric(F32Max),
            "f32.copysign" => Numeric(F32Copysign),
            "f64.add" => Numeric(F64Add),
            "f64.sub" => Numeric(F64Sub),
            "f64.mul" => Numeric(F64Mul),
            "f64.div" => Numeric(F64Div),
            "f64.min" => Numeric(F64Min),
            "f64.max" => Numeric(F64Max),
            "f64.copysign" => Numeric(F64Copysign),
