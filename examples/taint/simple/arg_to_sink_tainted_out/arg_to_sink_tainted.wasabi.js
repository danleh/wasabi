...
Wasabi.module.info = {"functions":[{"type":"i|","import":null,"export":["taint_source"],"locals":"","instrCount":1},{"type":"i|","import":null,"export":["taint_sink"],"locals":"","instrCount":1},{"type":"i|","import":null,"export":[],"locals":"","instrCount":3},{"type":"|","import":null,"export":[],"locals":"i","instrCount":7}],"globals":"","start":3,"tableExportName":null,"brTables":[],"originalFunctionImportsCount":0};
...
"start": function (func, instr, ) {
    Wasabi.analysis.start({func, instr}, );
},
